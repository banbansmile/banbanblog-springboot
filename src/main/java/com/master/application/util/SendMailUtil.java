...
public class SendMailUtil {
	...
	private static final String HOST = "smtp.sohu.com"; // smtp服务器
	private static final String FROM = "banbanb@sohu.com"; // 发件人地址

	private static final String USER = ""; // 用户名
	private static final String PWD = ""; // 邮箱授权码
	 ...
	 * @param pwd
	 */
	public static synchronized void send(String emailAddress, String context, String SUBJECT) {
	...
	public static void main(String[] args) {
		send("test@163.com", "这是一封测试邮件，请不要回复", "测试邮件");
	}
